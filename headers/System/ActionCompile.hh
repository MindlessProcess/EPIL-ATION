...
// Last update Tue Mar  4 15:41:42 2014 Lyoma Guillou
//
...
namespace	epil
{
  ...
  public:
    ...
    ActionCompile(std::string const &makefilePath, std::string const &makeCmd);
    ActionCompile(std::string const &cmd, std::string const &obj, std::string const &flag, std::string const &name);
